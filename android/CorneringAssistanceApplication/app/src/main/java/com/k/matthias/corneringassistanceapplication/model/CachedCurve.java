package com.k.matthias.corneringassistanceapplication.model;


import com.k.matthias.corneringassistanceapplication.util.BearingUtil;
import com.k.matthias.corneringassistanceapplication.util.Haversine;

/**
 * Entity class for a cached curve
 */
public class CachedCurve {
    ...
    public CachedCurve(long id, Location centerPoint, Location endPoint, Location startPoint, double radius, int recommendedSpeed, double startBearing, double endBearing) {
        this.id = id;
